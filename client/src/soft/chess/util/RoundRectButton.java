...
public class RoundRectButton extends JButton{
		  ...
		  * 获取按钮背景图片
		  */
		  Image default_image = new ImageIcon("assets/image/button/default_button.png").getImage();
		  Image hover_image = new ImageIcon("assets/image/button/mousemoveon_button.png").getImage();
		  Image press_image = new ImageIcon("assets/image/button/mousepress_button.png").getImage();
		  //如果点击
		  if(getModel().isArmed()){
...
//		  graphics2.draw(roundedRectangle);
		 ...
		 public static void main(String[] args){
			  ...
			  button.setFont(SoftConstant.mfont);
			  //产生一个框架显示这个按钮
